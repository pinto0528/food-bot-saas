    ...
    <nav className="space-y-1 px-3">
      ...
      <div className="pt-4 mt-4 border-t">
        ...
        >
          ...
          {!collapsed && <span>Ir al Dashboard</span>}
        </a>
      </div>
    </nav>
  )
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-background">
      ...
      <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
        <SheetTrigger className="md:hidden absolute top-3 left-3 z-50 inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors hover:bg-accent hover:text-accent-foreground h-9 w-9">
